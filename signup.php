...
<head>
  ...
  <title>House Rent | Sign Up</title>
    ...
    <div class="container">
      ...
      <div class="form__content--box">
        <div class="row">
          ...
          <div class="col-md-8 m-auto form__main-col">
              ...
              <div class="form-content">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    ...
                    <input class="form-control" name="email" placeholder="youremail @gmail.com" type="email" required>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-6">
                      <label class="control-label" for="mobile-no"></label>
                      <input class="form-control" name="mobile_no" placeholder="+8801*********" type="text" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="clearfix"></div>
                <div class="button__register button__sign">
                  <button type="submit" name="Sign_Up" class="btn btn-sign">Sign Up</button>
                </div>
...
<?php
   ...
   session_start();
      ...
      $sql="insert into user values(null,'$first_name','$last_name','$email','$mobile_no','$userName','$password')";
      ...
      if($result) {
         ...
         // header("Location:login.php");
            ...
            echo '<script type="text/javascript">
                     alert("Account create fail. Try again.");
                  </script>';
         }        
      } 
   }
